 ...
 */
namespace EzSystems\EzPlatformRestCommon\Tests\UrlHandler;
...
class PatternTest extends TestCase
{
    ...
    {
        $urlHandler = new EzPlatformRestCommon\RequestParser\Pattern();
     ...
     *
     * @return \EzSystems\EzPlatformRestCommon\RequestParser\Pattern
     */
    protected function getWorkingUrlHandler()
    {
        return new EzPlatformRestCommon\RequestParser\Pattern(
            array(
