...
class ParsingDispatcherTest extends TestCase
{
    ...
    {
        $dispatcher = new EzPlatformRestCommon\Input\ParsingDispatcher();
    ...
    public function testParse()
    {
        ...
        $dispatcher = new EzPlatformRestCommon\Input\ParsingDispatcher(['text/html' => $parser]);
    ...
    /**
     * @return \EzSystems\EzPlatformRestCommon\Input\Parser|\PHPUnit\Framework\MockObject\MockObject
     */
