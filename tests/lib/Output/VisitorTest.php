...
use EzSystems\EzPlatformRestCommon\Output\ValueObjectVisitorDispatcher;
...
class VisitorTest extends TestCase
{
    ...
    public function testVisitValueObject()
    {
        ...
        $visitor = new EzPlatformRestCommon\Output\Visitor($generatorMock, $valueObjectDispatcherMock);
        $visitor->visit($data);
    }
     ...
     *
     * @see \EzSystems\EzPlatformRestCommon\Output\Visitor::visit
     */
