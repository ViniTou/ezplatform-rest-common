 ...
 */
namespace EzSystems\EzPlatformRestCommon\Tests\Output\Generator;

use EzSystems\EzPlatformRestCommon\Tests\Output\GeneratorTest;
use EzSystems\EzPlatformRestCommon;
use EzSystems\EzPlatformRestCommon\Output\Generator\Json\FieldTypeHashGenerator;
...
class JsonTest extends GeneratorTest
{
    ...
    protected function getGenerator()
    {
        if (!isset($this->generator)) {
            $this->generator = new EzPlatformRestCommon\Output\Generator\Json(
