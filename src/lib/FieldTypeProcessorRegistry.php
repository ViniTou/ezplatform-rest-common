...
class FieldTypeProcessorRegistry
{
     ...
     *
     * @var \EzSystems\EzPlatformRestCommon\FieldTypeProcessor[]
     */
    private $processors = array();

    /**
     * @param \EzSystems\EzPlatformRestCommon\FieldTypeProcessor[] $processors
     */
     ...
     * @param \EzSystems\EzPlatformRestCommon\FieldTypeProcessor $processor
     */
