...
class FieldTypeSerializer
{
    ...
    /**
     * @var \EzSystems\EzPlatformRestCommon\FieldTypeProcessorRegistry
     */
    protected $fieldTypeProcessorRegistry;

    /**
     * @param \eZ\Publish\API\Repository\FieldTypeService $fieldTypeService
     * @param \EzSystems\EzPlatformRestCommon\FieldTypeProcessorRegistry $fieldTypeProcessorRegistry
     */
