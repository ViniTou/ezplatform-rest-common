 ...
 */
namespace EzSystems\EzPlatformRestCommonBundle\DependencyInjection;
 ...
 */
class EzPlatformRestCommonExtension extends Extension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
